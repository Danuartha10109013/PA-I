...
<table width="100%" style="margin-top: 50px; font-size: 12px;">
  <tr>
    ...
    <td style="width: 50%; text-align: center;">
      Best Regards,<br><br>
      <img src="{{ public_path('storage/'.$data->best_regards_signature) }}" style="max-height: 80px; margin-bottom: -20px;">
      <div style="border-top: 1px solid #000; width: 70%; margin: 60px auto 0;"></div>
      {{ $data->best_regards }}
    </td>
  </tr>
    ...
    <!-- Footer -->
    <div class="footer" style="margin-top: 150px;margin-bottom: -10px">
