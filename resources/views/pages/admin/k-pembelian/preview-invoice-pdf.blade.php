...
<body>
  ...
  <table class="description-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          Rp. {{ number_format($data->dpp, 0, ',', '.') }}<br>
      ...
      <tr>
        ...
        <td>
          Rp. {{ number_format($data->vat, 0, ',', '.') }}<br>
    ...
    <tfoot>
      <tr>
        ...
        <td>
          Rp. {{ number_format($data->grand_total, 0, ',', '.') }}<br>
  ...
  <div class="signatures">
    ...
    <div class="signature-block">
      ...
      Best Regards,<br><br>
      <img  src="{{ asset('storage/' . $data->best_regards_signature) }}" style="max-height: 80px; margin: 10px auto; display:block;">
